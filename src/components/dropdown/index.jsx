...
const Navbar = ({children}) => {
  ...
  return (
    <div className='relative'>
        <button className='flex space-x-2 justify-center items-center gap-2 text-2xl text-text-secondary first-letter:capitalize' onClick={toggleDropdown}>{children} <AiOutlineDown className='text-primary-text'/></button>
